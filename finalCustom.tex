...
{\Large\thesisName} \par
{First supervisor: \Large PD Dr.~Oleg Lobachev} \par
...
such as\footnote{Inspired and adapted from
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{return}\mathbin{\$}\Conid{Thunk}\;\{\mskip1.5mu \Varid{fromThunk}\mathrel{=}\Varid{ser}\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\vspace{-2\baselineskip}
